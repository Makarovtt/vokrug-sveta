...
export function BannerDescription() {
  return (
    <div className="320:px-5">
      <div
        className="flex justify-center items-center text-white font-bold py-10
      ...
      <div
        className="flex flex-col justify-between items-start w-full max-w-[1000px] mx-auto gap-7
